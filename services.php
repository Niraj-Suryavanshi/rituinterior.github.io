...
<!-- Collect the nav links, forms, and other content for toggling -->
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<nav class="menu menu--francisco">
								<ul class="nav navbar-nav menu__list">
									...
									<li class="menu__item menu__item--current"><a href="services.php" class="menu__link"><span class="menu__helper">Services</span></a></li>
	...
	<div class="banner1">
		<div class="container">
			<h3 class="animated wow slideInLeft" data-wow-delay=".5s"><a href="index.php">Home</a> / <span>Services</span></h3>
		</div>
	</div>
	<!--banner-->
<div class="content">
