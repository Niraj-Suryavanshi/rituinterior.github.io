						...
						<ul class="navbar-nav ml-lg-auto">
							...
							<li class="nav-item dropdown active">
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									<a class="dropdown-item" href="index.php">Services</a>
									<a class="dropdown-item" href="about.php">Testimonials</a>
									<div class="dropdown-divider"></div>
									<a class="dropdown-item" href="about.php">What We do</a>
									<a class="dropdown-item  active" href="single.php">Some More</a>
								</div>
							</li>
			...
			<div class="row blog-content">
				...
				<div class="col-lg-8 left-blog-info text-left">
					<div class="blog-grid-top">
						...
						<h1>
							<a href="single.php" class="single-text text-dark font-weight-light">Nemo enim ipsam voluptatem quia
								voluptas
					...
					<div class="event-right1">
						...
						<div class="tags p-4 border">
							...
							<ul class="mt-4">
								...
								<li>
									<a href="single.php" class="text-dark border">Style</a>
								</li>
								<li>
									<a href="single.php" class="text-dark border">Model</a>
								</li>
								<li>
									<a href="single.php" class="text-dark border">New Trends</a>
								</li>
								<li>
									<a href="single.php" class="text-dark border">Advantage</a>
								</li>
								<li>
									<a href="single.php" class="text-dark border">Excellent</a>
								</li>
								<li>
									<a href="single.php" class="text-dark border">Beautiful</a>
								</li>
								<li>
									<a href="single.php" class="text-dark border">Styles</a>
								</li>
								<li>
									<a href="single.php" class="text-dark border">Research</a>
								</li>
								<li>
									<a href="single.php" class="text-dark border">Trendy</a>
								</li>
							</ul>
						</div>
					</div>
